...
In this repository, I present the **production technology, systems thinking, and workflow architecture** behind my work on **SAMF**, broadcast across **Documentary · Institutional Distribution & Archival**.
...
* **RESULT**: I delivered a polished, archival-grade historical documentary master suitable for international institutional distribution and cultural preservation.
* **CHALLENGE**: I synthesised historical archive footage, fresh principal photography, field interviews, and musical recordings into one cohesive master with strict preservation integrity.
* **CONTRIBUTION**: I spearheaded the complete production lifecycle: pre-production, principal photography direction, editing, colour grading, audio conform, technical QC, and final mastering.
* **DELIVERY**: I produced DCP, high-bitrate ProRes 422 HQ preservation masters, and streaming delivery packages with full metadata and archival logging.
...
├── assets/
│   └── SAMF.webp                 ← Production visual master
├── diagrams/
