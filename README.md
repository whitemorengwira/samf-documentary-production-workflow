...
This repository presents the **production technology, systems thinking, and workflow architecture** behind **SAMF**, broadcast across **Documentary · Institutional Distribution & Archival**.
...
* **RESULT**: Delivered a polished, archival-grade historical documentary master suitable for international institutional distribution and cultural preservation.
* **CHALLENGE**: Synthesising historical archive footage, fresh principal photography, field interviews, and musical recordings into one cohesive master with strict preservation integrity.
* **CONTRIBUTION**: Spearheaded the complete production lifecycle: pre-production, principal photography direction, editing, colour grading, audio conform, technical QC, and final mastering.
* **DELIVERY**: DCP, high-bitrate ProRes 422 HQ preservation masters, and streaming delivery packages with full metadata and archival logging.
